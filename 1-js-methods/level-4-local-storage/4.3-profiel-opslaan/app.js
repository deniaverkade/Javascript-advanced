...
function slaProfielOp() {
    ...
    localStorage.setItem('profiel-opgeslagen', time = new Date());
...
function toonProfiel() {
    ...
    const leeftijd = localStorage.getItem("profiel-leeftijd");
    const kleur = localStorage.getItem("profiel-kleur");
    const opgeslagenOp = time;
    
    // TODO: Check of er profiel data is
    if (localStorage.getItem("profiel-opgeslagen")) {
...
// TODO: Initialisatie
function init() {
    localStorage.getItem("profiel-opgeslagen");
}
